    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="Assets/images/avatar.png"
                alt="User Image">
            <div>
                <p class="app-sidebar__user-name">Agustin Guerrero</p>
                <p class="app-sidebar__user-designation">Desarrollador Web</p>
            </div>
        </div>
        <ul class="app-menu">
